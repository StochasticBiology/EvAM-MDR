...
Now, open the file `EvAM-MDR.R` and run it. One of the first lines in that file is a command that will install the HyperTraPS-CT package. For backward compatibility this pulls the version from https://github.com/StochasticBiology/hypertraps-ct/tree/bioconductor . The maintained version is here https://github.com/StochasticBiology/hypertrapsct .
...
[1] Renz, J., Dauda, K.A., Aga, O.N., Diaz-Uriarte, R., Löhr, I.H., Blomberg, B. and Johnston, I.G., 2025. Evolutionary accumulation modeling in AMR: machine learning to infer and predict evolutionary dynamics of multi-drug resistance. Mbio, 16(6), pp.e00488-25. https://journals.asm.org/doi/10.1128/mbio.00488-25
